...
CFG = {
    ...
    'FOLD': 5,
    'START_FOLD': None, # Fold를 중간부터 시작할 때 (처음부터 수행하려면 None 또는 0으로 설정)
    ...
    'INITIAL_RATIO': None, # 처음 시작할 때 Hard Negative Sampling Ratio 설정 
    'FINAL_RATIO': None, # 마지막 끝날 때 Hard Negative Sampling Ratio 설정
    'HARD_NEGATIVE_CURRICULUM_LEARNING_EPOCH': 0,
