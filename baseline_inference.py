...
if __name__ == '__main__':
    ...
    # 모델 정의
    model = timm.create_model('inception_resnet_v2', pretrained=True, num_classes=7).to(device)
    checkpoint = torch.load('model_epoch_26.pth', map_location=device)
    ...
    submit.to_csv('./baseline_submit_26epoch.csv', index=False)