...
if __name__ == '__main__':
    ...
    # 모델 정의
    model = timm.create_model('eva_large_patch14_336.in22k_ft_in1k', pretrained=True, num_classes=7).to(device)
    checkpoint = torch.load('eva_epoch_8.pth', map_location=device)
    ...
    submit.to_csv('./eva_submit_8epoch.csv', index=False)